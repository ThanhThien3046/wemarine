...
<!-- InstanceBeginEditable name="doctitle" -->
	...
	<meta property="og:description" content="WE・RENTACARの公式予約サイト「WE・RENTACAR Webサイト」のお問い合わせです。" />
	<meta name="description" content="WE・RENTACARの公式予約サイト「WE・RENTACAR Webサイト」のお問い合わせです。">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-HEB03E1LGE"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-HEB03E1LGE');
</script>
    ...
    <div class="nav-top">
        <div class="menu-slogan">
            <div class="logo"> 
                    ...
                    <div id="js-nav" class="navigation">
						<nav class="nav">
							<ul class="list">
								...
								<li><a href="about.html">WE・RENTACARについて<i class="fas fa-angle-right"></i></a></li>
                ...
                <div class="nav-bar2">
                    <i class="fas fa-caret-right"></i><a href="guide.html">ご利用ガイド</a>
						...
						<div class="menu-drow">
								<ul class="drow-menu">
									<li><a href="about.html">
										<img src="images/company/about-us.jpg" width="600" height="300" alt="会社について"/> 
										<p>会社について</p>
										</a>
									</li>
									<li><a href="message.html">
										<img src="images/company/message.jpg" width="600" height="300" alt="代表メッセージ"/> 
										<p>代表メッセージ</p>
										</a>
									</li>
									<li><a href="manage.html">
										<img src="images/company/manage.jpg" width="600" height="300" alt="経営理念"/> 
										<p>経営理念</p>
										</a>
									</li>
									<li><a href="corporate.html">
										<img src="images/company/corporate.jpg" width="600" height="300" alt="企業理念"/> 
										<p>企業理念</p>
										</a>
									</li>
									<li><a href="credo.html">
										<img src="images/company/credo.jpg" width="600" height="300" alt="行動指針"/> 
										<p>行動指針</p>
										</a>
									</li>
									<li><a href="profile.html">
										<img src="images/company/profile.jpg" width="600" height="300" alt="会社概要"/>  
										<p>会社概要</p>
										</a>
									</li>
								</ul>
						...
						<div class="menu-drow">
								<ul class="drow-menu">
									<li><a href="hijet.html">
										<img src="images/list-car/hijet.jpg" width="600" height="300" alt="ハイゼット"/>
										<p>ハイゼット</p>
										</a>
									</li>
									<li><a href="aqua.html">
										<img src="images/list-car/aqua.jpg" width="600" height="300" alt="アクア"/>
										<p>アクア</p>
										</a>
									</li>
									<li><a href="prius.html">
										<img src="images/list-car/prius.jpg" width="600" height="300" alt="プリウス"/>
										<p>プリウス</p>
										</a>
									</li>
									<li><a href="priusa.html">
										<img src="images/list-car/priusa.jpg" width="600" height="300" alt="プリウスα"/>
										<p>プリウスα</p>
										</a>
									</li>
									<li><a href="serena.html">
										<img src="images/list-car/serena.jpg" width="600" height="300" alt="セレナ"/>
										<p>セレナ</p>
										</a>
									</li>
									<li><a href="vellfire.html">
										<img src="images/list-car/vellfire.jpg" width="600" height="300" alt="ヴェルファイア"/>
										<p>ヴェルファイア</p>
										</a>
									</li>
								</ul>
...
<!--ーーーーーーーーーーーーーー CONTACT　ここからーーーーーーーー -->
 ...
 <!--ーーーーーーーーーーーーーー FOOTER　ここからーーーーーーーー -->
        <div class="footer">
            ...
            <ul class="ul-footer footer-pc">
                <li class="ul-li-footer">
                    ...
                    <p class="li-footer-content">
						<a href="index.html#reasons"><i class="fas fa-angle-right"></i> 選ばれる理由</a><br>
						<a href="index.html#list-car"><i class="fas fa-angle-right"></i> 車種と料金</a><br>
                ...
                <li class="ul-li-footer">
                    ...
                    <p class="li-footer-content">
						<a href="guide.html"><i class="fas fa-angle-right"></i> ご利用ガイド</a><br>
            ...
            <ul class="footer-smt">
				<li><a href="guide.html"><i class="fas fa-angle-right"></i> ご利用ガイド</a></li>
